  ...
  init: function (start) {
    if (start != 0){
      ...
      if (i !== -1) {
        ...
        S.UI.simulate('|#countdown 3||祝|赵鑫媛|生日快乐|祝你|生日快乐|祝你幸福|祝你健康|百事可乐|祝你|生日快乐！|#icon heart|#icon heart-empty|#icon heart');
      }
  ...
  function performAction(value, start) {
    ...
    timedAction(function (index) {
      ...
      switch (action) {
        ...
        default:
          S.Shape.switchShape(S.ShapeBuilder.letter(current[0] === cmd ? 'Ready?' : current));
      }
  ...
  return {
    imageFile: function (url, callback) {
      ...
      image.onerror = function () {
        callback(S.ShapeBuilder.letter('Ready?'));
      }
